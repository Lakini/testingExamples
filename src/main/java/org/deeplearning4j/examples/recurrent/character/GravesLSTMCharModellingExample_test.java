...
/**
 * Created by Lakini on 7/23/2016.
 */

public class GravesLSTMCharModellingExample_test {
    ...
    // Load the dataset
	private static CharacterIterator getIterator(int miniBatchSize, int sequenceLength) throws Exception{

        String fileLocation = "C:/Users/Lakini/Desktop/uk dataset.txt";	//Storage location from downloaded file
